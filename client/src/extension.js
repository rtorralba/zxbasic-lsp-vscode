...
const allZxBasicTokens = [
    "AS", "BEEP", "BIN", "BORDER", "BRIGHT", "CAT", "CIRCLE", "CLEAR", "CLOSE#", "CLS", "CONTINUE", "COPY", "DATA", "DEF FN", "DIM", "DRAW", "ERASE", "FLASH", "FORMAT", "FOR", "GO SUB", "GO TO", "IF", "END IF", "INK", "INPUT", "INVERSE", "LET", "LIST", "LLIST", "LOAD", "LPRINT", "MERGE", "MOVE", "NEW", "NEXT", "ON", "OUT", "OVER", "PAPER", "PAUSE", "PLOT", "POKE", "PRINT", "RANDOMIZE", "READ", "RESTORE", "RETURN", "RUN", "SAVE", "VERIFY", "AT", "LINE", "STEP", "TAB", "THEN", "TO", "STOP", "DO", "ELSE", "ELSEIF", "END", "END SUB", "END FUNCTION", "EXIT", "FUNCTION", "GOTO", "GOSUB", "LOOP", "WEND", "WHILE", "BOLD", "ByRef", "ByVal", "CONST", "DECLARE", "FastCall", "ITALIC", "StdCall", "SUB", "UNTIL", "BANK", "LAYER", "PALETTE", "SPRITE", "TILE", "TO", "REMOUNT", "PWD", "CD", "MKDIR", "RMDIR", "ASM", "END ASM", "ALIGN",
